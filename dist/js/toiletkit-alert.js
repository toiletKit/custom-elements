class JoomlaAlertElement extends HTMLElement {
  ...
  connectedCallback() {
    ...
    this.classList.add('toiletkit-alert--show');
  ...
  attributeChangedCallback(attr, oldValue, newValue) {
    switch (attr) {
      ...
      case 'href':
        ...
        } else if (this.firstElementChild.tagName && this.firstElementChild.tagName.toLowerCase() !== 'button' && this.firstElementChild.classList.contains('toiletkit-alert-button--close')) {
          this.appendCloseButton.bind(this)();
        }
        break;
      case 'auto-dismiss':
  ...
  appendCloseButton() {
    ...
    if (this.hasAttribute('dismiss')) {
      closeButton.classList.add('toiletkit-alert--close');
      closeButton.innerHTML = '<span aria-hidden="true">&times;</span>';
      closeButton.setAttribute('aria-label', this.textClose);
    } else {
      closeButton.classList.add('toiletkit-alert-button--close');
...
customElements.define('toiletkit-alert', JoomlaAlertElement);
