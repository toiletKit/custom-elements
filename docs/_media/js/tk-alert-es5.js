...
var _createClass = function () {
  ...
  function b() {
    return _classCallCheck(this, b), _possibleConstructorReturn(this, (b.__proto__ || Object.getPrototypeOf(b)).apply(this, arguments));
      ...
      this.dispatchCustomEvent('toiletkit.alert.show'), this.setAttribute('role', 'alert'), this.classList.add('tk-alert--show'), this.type || this.setAttribute('type', 'primary'), (this.hasAttribute('dismiss') || this.hasAttribute('acknowledge') || this.hasAttribute('href') && '' !== this.getAttribute('href')) && !this.querySelector('button.tk-alert--close') && !this.querySelector('button.tk-alert-button--close') && this.appendCloseButton.bind(this)(), this.dispatchCustomEvent('toiletkit.alert.show'), this.closeButton && this.closeButton.focus();
      ...
      switch (a) {case 'type':
          c && -1 !== ['primary', 'warning', 'success', 'danger'].indexOf(c) || (this.type = 'primary');break;case 'dismiss':case 'acknowledge':
